...
data1 = readAndPrepareAnnotations("annotations/first/extracted.csv",removeDuplicates)
data2 = readAndPrepareAnnotations("annotations/second/extracted.csv",removeDuplicates)
