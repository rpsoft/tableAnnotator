# derived from 10_unpivot_tables
...
setwd("~/ihw/tableAnnotator/annotations")
...
# annotations <- read_csv("second/second_annotations.csv")
annotations <- read_csv("first/first_batch_results.csv")
